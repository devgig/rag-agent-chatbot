...
At the core is a supervisor agent powered by Nemotron-3-70B, orchestrating document retrieval through MCP (Model Context Protocol) tool servers.
...
flowchart TB
    ...
    subgraph Models["Model Servers"]
        LLM[Nemotron-3-70B<br/>Supervisor LLM]
...
| **Supervisor LLM** | vLLM (Nemotron-3-70B-Instruct) | Main reasoning, tool selection |
